...
None remaining as of this pass — the last item (`xmppcomm.py`'s dead `_capability_type`/`_CAPABILITY_NS`, found while checking Phase 7) has been removed. All phases in the Work Plan below are ✅.
