...
## Corpus Check
- 893 files · ~505,398 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9170 nodes · 21557 edges · 478 communities (406 shown, 72 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 1372 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d522f313`
...
## Communities (478 total, 72 thin omitted)

### Community 0 - "utils/exceptions.py"
Cohesion: 0.07
Nodes (33): PipelineCamera, Any, A virtual camera based on an image pipeline., Creates a new pipeline cammera., Grabs an image and returns reference. Args: broadcast: Broadcast existence of…, Declare that the given PyobsError types (and their subclasses) fire often…, AbortedError, AcquisitionError (+25 more)
...
### Community 2 - "Time"
Cohesion: 0.04
Nodes (79): PolymorphicBaseModel, Constraint, ndarray, SkyCoord, Returns a boolean mask of candidates passing this constraint. Default…, MoonIlluminationConstraint, Moon illumination constraint., TimeConstraint (+71 more)

### Community 3 - "Module"
Cohesion: 0.02
Nodes (128): AbstractEventLoop, ModuleOpenedEvent, Event to be sent when a module has opened., ConfigCapabilities, ModuleLocation, A module in *pyobs* is the smalles executable unit. The base class for all…, Module, MultiModule (+120 more)
...
Cohesion: 0.07
Nodes (21): IFitsHeaderBefore, MotionStatusMixin, BaseTelescope, BodyResolutionError, _ra_rate_on_sky(), On-sky RA rate in arcsec/sec, i.e. d(RA)/dt * cos(dec) -- matches JPL Horizons'…, Base class for telescopes., Current RA/Dec position in degrees, or None if unknown. Override in subclasses. (+13 more)
...
Cohesion: 0.04
Nodes (43): Response, Handles access to /* and returns a specified image. Args: request: Request to…, Observation, Any, Fetch a task from the task archive., AcquisitionConfig, Configuration, GuidingConfig (+35 more)

### Community 8 - "FlatField"
Cohesion: 0.07
Nodes (27): IBinning, Any, The camera supports binning, to be used together with…, Set the camera binning. Args: x: X binning. y: Y binning. Raises: ValueError:…, IFilters, Any, The module can change filters in a device., Set the current filter. Args: filter_name: Name of filter to set. Raises:… (+19 more)
...
Cohesion: 0.03
Nodes (105): ABC, The Comm object is responsible for all communication between modules (see…, IAbortable, The module has an abortable action., IAutoGuiding, The module can perform auto-guiding., ICalibrate, The module can calibrate a device. (+97 more)
...
Cohesion: 0.10
Nodes (36): Mastermind, Any, Returns FITS header for the current status of this module. Args: namespaces: If…, Mastermind for a full robotic mode., Compute and persist the next per-night observation number. Returns: Compound…, _clear_vfs_buffer(), make_mastermind(), make_obs() (+28 more)
...
### Community 20 - "Event"
Cohesion: 0.05
Nodes (46): Event, Base class for all events., DataType, TypedDict, DataType, TypedDict, DataType, TypedDict (+38 more)

### Community 21 - "FitsHeaderEntry"
Cohesion: 0.03
Nodes (72): IDome, The module controls a dome, i.e. a :class:`~pyobs.interfaces.IRoof` with a…, FilterState, Any, Returns FITS header for the current status of this module. Args: namespaces: If…, FitsHeaderEntry, Any, Returns FITS header for the current status of this module. Args: namespaces: If… (+64 more)

### Community 22 - "_DummyTelescopeBase"
Cohesion: 0.05
Nodes (32): IFocuser, The module is a focusing device., AltAzOffsetState, RaDecOffsetState, DummyAltAzTelescope, Any, A dummy alt/az-offset telescope for testing, offering Alt/Az offsets., Creates a new dummy Alt/Az telescope. Args: offsets: Initial Alt/Az offsets in… (+24 more)
...
Cohesion: 0.04
Nodes (64): Comm API doc (pyobs.comm), Events API doc (pyobs.events), BadWeatherEvent, Event to be sent on bad weather., Create Event from a dictionary. Args: obj_dict: JSON string for event. Returns:…, ExposureStatusChangedEvent, Event to be sent, when the exposure status of a device changes., FilterChangedEvent (+56 more)

### Community 26 - "test_lco_http.py"
Cohesion: 0.09
Nodes (42): Camera, CameraType, ConfigurationType, Enclosure, Instrument, InstrumentType, Mode, ModeType (+34 more)
...
Cohesion: 0.09
Nodes (33): OrbitalElements, OrbitalElements, Any, Starts tracking a body defined by orbital elements. Args: elements: Orbital…, InvalidOrbitalElementsError, _orbital_plane_to_ecliptic_cartesian(), _perifocal_to_radec(), _propagate_elements() (+25 more)
...
Cohesion: 0.05
Nodes (34): ExposureStatus, Header, IDataSequence, IExposure, IExposureTime, IImageType, ImageFitsHeaderMixin, NamedTuple (+26 more)
...
### Community 36 - "Future"
Cohesion: 0.05
Nodes (45): Wait until all devices are in one of the given motion states. Args: abort:…, ImagingScript, Any, Target, Whether this config can currently run. Returns: True, if the script can run now, Run script. Raises: InterruptedError: If interrupted, Returns FITS header for the current status of this module. Args: namespaces: If…, Estimate the duration of this script in seconds. (+37 more)

### Community 37 - "PolymorphicBaseModel"
Cohesion: 0.11
Nodes (15): HeliocentricPolarTarget, SkyCoord, Target, HelioprojectiveTarget, SkyCoord, Target, CsvPicker, A helper class for picking a target from a list. (+7 more)

### Community 38 - "xmppcomm.py"
Cohesion: 0.09
Nodes (35): _dataclass_to_xml(), _event_schema_to_xml(), _interface_schema_to_xml(), _parse_scalar(), Any, Element, Shared XML serializer for pyobs 2.0 (urn:pyobs:rpc:1). Both the state pub/sub…, Deserialize an XML element (produced by ``value_to_xml``) to a Python value.… (+27 more)

### Community 39 - "acquisition.py"
Cohesion: 0.05
Nodes (47): AcquisitionAttempt, AcquisitionResult, AcquisitionState, IAcquisition, Any, The module can acquire a target, usually by accessing a telescope and a camera., Acquire target at given coordinates. If no RA/Dec are given, start from current…, ICamera (+39 more)

### Community 40 - "test_acquisition.py"
Cohesion: 0.22
Nodes (31): ExpTime, OffsetResult, test_exp_time(), make_acquisition(), make_camera(), make_image(), make_telescope(), asyncio (+23 more)
...
### Community 47 - "SiderealTarget"
Cohesion: 0.06
Nodes (54): AirmassConstraint, ndarray, SkyCoord, MoonSeparationConstraint, ndarray, SkyCoord, Moon separation constraint., model_validator (+46 more)
...
### Community 52 - "test_localcomm_state.py"
Cohesion: 0.04
Nodes (84): ModuleClosedEvent, Event to be sent when a module has closed., ModuleCapabilities, WindowCapabilities, asyncio, fixture, Tests for LocalComm state, capabilities, and presence., set_presence stores and get_client_state retrieves. (+76 more)
...
Cohesion: 0.09
Nodes (39): AstroplanScheduler, Any, ObservingBlock, Actually do the scheduling, usually run in a separate process., Scheduler based on astroplan., Initialize a new scheduler. Args: twilight: astronomical or nautical, DynamicTarget, Queue (+31 more)

### Community 68 - "TimeDelta"
Cohesion: 0.08
Nodes (57): ConstantMerit, Merit function that returns a constant value., model_validator, Self, Merit function that uses time windows., TimeWindow, TimeWindowMerit, OnDemandScheduler (+49 more)

### Community 69 - "Offsets"
Cohesion: 0.03
Nodes (60): GenericOffset, OnSkyDistance, Angle, PixelOffsets, AstrometryOffsets, CorrelationMaxCloseToBorderError, Any, Exception (+52 more)

### Community 70 - ".now"
Cohesion: 0.10
Nodes (27): Observer, ObservationArchiveEvolution, date, Observer, Populates the task cache and the one real night (anchored to `start`) up front.…, Freezes observation cache. After this: a task-id miss raises RuntimeError; a…, Returns list of observations for the given task. Args: date: Date of night to…, Run script. Raises: InterruptedError: If interrupted (+19 more)
...
### Community 76 - "IPointingAltAz"
Cohesion: 0.05
Nodes (51): AltAzState, IPointingAltAz, The module can move to Alt/Az coordinates, usually combined with…, RaDecState, build_skycoord(), FollowMixin, get_coords(), Any (+43 more)
...
Cohesion: 0.11
Nodes (48): ConditionalRunner, Script for running an if condition., ParallelRunner, Script for running other scripts in parallel., Script for running Mode Selection., # TODO: get a better estimate for mode-change durations, SelectorScript, Script for running a sequence of other scripts. (+40 more)
...
### Community 81 - "._move_radec"
Cohesion: 0.09
Nodes (19): FitsHeaderEntry, Grabs an image ans returns reference. Args: broadcast: Broadcast existence of…, AltitudeLimitError, _format_dec(), _format_ra(), MissingObserverError, Actually starts tracking on given coordinates. Must be implemented by derived…, Starts tracking on given coordinates. Args: ra: RA in deg to track. dec: Dec in… (+11 more)
...
### Community 83 - "test_csvpicker_scheduler.py"
Cohesion: 0.25
...
Cohesion: 0.06
Nodes (39): Handle an ImageError raised by this step, when on_error == "error". Override…, PipelineMixin, Any, Mixin for a module that needs to implement an image pipeline., Initializes the mixin. Args: steps: Pipeline steps to run on images. archive:…, Whether the given class declares an `archive` parameter anywhere in its…, Resets all previous state of the involved image processors., Pipeline (+31 more)
...
### Community 87 - "test_schedulereader.py"
Cohesion: 0.31
...
Cohesion: 0.06
Nodes (40): Application, GuiApplication, React to signals and quit the module., Actually run the application., Derived Application class that uses a Qt GUI. Allows for graceful shutdown in…, Force astropy's IERS-A table and leap-second table to be loaded/downloaded now,…, Class for initializing and shutting down a pyobs process., _warm_iers_cache() (+32 more)
...
Cohesion: 0.10
Nodes (25): LcoScript, Script for LCO configs. Dispatches to one of the named scripts in ``scripts``,…, Build the script selected via the configuration's extra_params["script_name"].…, Whether this config can currently run. Returns: True, if the script can run now, Run script. Raises: InterruptedError: If interrupted, Returns FITS header for the current status of this module. Args: namespaces: If…, Estimate duration based on the duration calculated by the LCO portal., FakeScript (+17 more)
...
### Community 116 - "pyobs/images/meta/__init__.py"
Cohesion: 0.19
...
### Community 128 - "LcoDefaultScript"
Cohesion: 0.40
Nodes (3): LcoDefaultScript, Returns FITS header for the current status of this module. Args: namespaces: If…, Default script for LCO configs.
...
Cohesion: 0.09
Nodes (11): Any, JSON representation of event., String representation of event., Generic from_dict method for derived classes that don't need their own., Any, Any, Any, Any (+3 more)

### Community 134 - "flatfield/test_scheduler.py"
Cohesion: 0.61
Nodes (7): make_scheduler_module(), asyncio, setup_flatfield_proxy(), test_abort_sets_event(), test_run_aborts_current_flat_field_when_requested(), test_run_raises_when_already_running(), test_run_schedules_and_executes_items()
...
### Community 137 - "timeout"
Cohesion: 0.14
Nodes (12): FlatFieldScheduler, Any, Abort current actions., Run the flat-field scheduler., Initialize a new flat field scheduler. Args: flatfield: Flat field module to…, Perform flat-fielding Raises: DeviceBusyError: If a flat-fielding run is…, Decorates a method with information about timeout for an async HTTP call.…, timeout() (+4 more)
...
### Community 142 - "test_reduction.py"
Cohesion: 0.51
Nodes (10): make_frame_headers(), asyncio, Path, test_calibration_failure_for_one_combination_does_not_abort_others(), test_output_local_path_auto_creates_directory_and_writes_there(), test_output_routes_to_different_archive_than_input(), test_progress_callback_error_in_callback_does_not_abort_reduction(), test_progress_callback_reports_calibs_and_cumulative_science_frames() (+2 more)
...
Cohesion: 0.08
Nodes (29): Any, LcoRequest, LcoSchedulableRequest, LcoTask, Target, Returns observation_type of this task. Returns: observation_type of this task., Whether this task is allowed to start later than the user-set time, e.g., for…, Whether task is finished. (+21 more)

### Community 149 - ".can_run"
Cohesion: 0.17
...
Cohesion: 0.21
Nodes (9): ExpTimeEval, Estimate exposure time for given filter Args: solalt: Solar altitude. binning:…, Estimates exposure time for a given filter and binning at a given time offset…, Exposure time evaluator for skyflats., Estimates the duration for a given amount of flats in the given filter and…, test_parse_config_bias(), test_parse_config_filter(), test_parse_config_full() (+1 more)
...
### Community 167 - "SchedulerItem"
Cohesion: 0.20
Nodes (6): Iterate over scheduler items, Return schedule item., A single item in the flat scheduler, Initializes a new scheduler item Args: start: Start time in seconds end: End…, Nice string representation for item, SchedulerItem

### Community 168 - "RemoteError"
Cohesion: 0.20
...
### Community 170 - "Script"
Cohesion: 0.13
Nodes (18): Checks whether this script could run now. Returns: True, if the script can run…, Returns reason why script cannot run, or None if it can., Run script. Raises: InterruptedError: If interrupted, Returns FITS header for the current status of this module. Args: namespaces: If…, Estimate duration of this script in seconds., Script, DebugTriggerScript, Script for a debug trigger. (+10 more)
...
Cohesion: 0.22
Nodes (7): Any, Any, Initialize a new scheduler. Args: twilight: astronomical or nautical, Resolve a `type` shorthand key (e.g. `type: Airmass`) into an explicit `class`…, resolve_polymorphic_type_shorthand(), Regression test: Constraint.create() derives `class` from the `type` shorthand…, test_create_with_type_shorthand_does_not_raise()
...
### Community 204 - "test_module_state_publishing.py"
Cohesion: 0.33
...
### Community 211 - "._handle_event_sync"
Cohesion: 0.33
Nodes (3): Handles an event. Args: msg: Received XMPP message. node: pubsub node id the…, Recover the publishing module's name from an event node id, since notifications…, Synchronous entry point for the MatchXMLMask Callback. State-node dispatch is…
...
Cohesion: 0.06
Nodes (33): Any, Image, ImageType, IVideo, NDArray, Set the image type. Args: image_type: New image type., BaseVideo, NextImage (+25 more)
...
Cohesion: 0.08
Nodes (30): ProgressEvent, Archive, Any, Base class for image archives., ImageType, Enumerator specifying the image type. Attributes: BIAS: Bias/zero exposure.…, Pipeline, Any (+22 more)
...
### Community 237 - "Plan: `IDataSequence` — server-side counted data sequences (reconstructed)"
Cohesion: 0.33
...
Cohesion: 0.09
Nodes (32): PydanticBaseModel, Object, Base class for all objects in *pyobs*., Whether object has been opened., Can be overloaded to quit program., ConfigurationStatus, ConfigurationSummary, LcoAcquisitionConfig (+24 more)
...
### Community 253 - "test_dummyaltaztelescope.py"
Cohesion: 0.70
...
Cohesion: 0.15
Nodes (10): ConfigStatus, Any, Run a config Args: script: Script to run Returns: Configuration status to send…, Status of a single configuration., Initializes a new Status with an ATTEMPTED., Finish this status with the given values and the current time. Args: state:…, Convert status to JSON for sending to portal., DuplicateFilter (+2 more)

### Community 258 - "RuntimeError"
Cohesion: 0.07
Nodes (27): Exposure Time estimators doc, ExpTimeEstimator (exptime processor base), StarExpTimeEstimator (exptime processor), ExpTimeEstimator, Any, Estimate exposure time., Init new exposure time estimator., Any (+19 more)

### Community 259 - "object.py"
Cohesion: 0.05
Nodes (35): BaseModel, Modules for robotic mode. TODO: write doc, Initialize a new auto focus system. Args: schedule: Object that can return…, # TODO: add abort (see old robotic/scheduler.py), :class:`~pyobs.object.Object` is the base for almost all classes in *pyobs*. It…, Abstract base class for tasks scheduler., TaskScheduler, LcoTaskRunner (+27 more)

### Community 260 - "RunningState"
Cohesion: 0.05
Nodes (51): F, AutoFocusResult, AutoFocusState, IAutoFocus, Any, SECONDS, The module can perform an autofocus., Perform an autofocus series. This method performs an autofocus series with… (+43 more)
...
Cohesion: 0.04
Nodes (76): ObservationList, ObservationState, StrEnum, FileSystemObservationArchive, Any, date, Clear schedule after given start time. Args: start_time: Start time to clear…, Fetch schedule from portal. Returns: Dictionary with tasks. Raises: Timeout: If… (+68 more)
...
### Community 292 - ".get_sensor_value"
Cohesion: 0.22
...
Cohesion: 0.04
Nodes (67): Binning, BinningCapabilities, ICooling, The module can control the cooling of a device., ExposureState, GainState, IImageFormat, ImageFormatCapabilities (+59 more)

### Community 294 - "pyobs/modules/utils/__init__.py"
Cohesion: 0.10
Nodes (11): FluentLogger, Any, Log to fluentd server., Initialize a new logger. Args: hostname: Hostname of server. port: Port of…, Process a new log entry. Args: event: The log event. sender: Name of sender., Utilities TODO: write doc, Matrix, Any (+3 more)
...
### Community 339 - "._get_radec_center_target"
Cohesion: 0.50
Nodes (3): EarthLocation, SkyCoord, Return RA/Dec of central pixel and of central pixel plus offsets. Args: image:…
...
### Community 344 - "DummySpectrograph"
Cohesion: 0.12
...
## Knowledge Gaps
- **682 isolated node(s):** `Problem`, `What's already done`, `What's broken — verified against pyobs-core 2.0.0.dev93`, `Design decisions`, `1. `pyobs_iag50/aligntest.py`` (+677 more)
...
- **What is the exact relationship between `FocusError` and `FocusModel.set_optimal_focus`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Time` connect `Time` to `.__init__`, `Observation`, `Interface`, `test_mastermind.py`, `Event`, `FitsHeaderEntry`, `_DummyTelescopeBase`, `test_flatfielder.py`, `tests/test_events.py`, `test_lco_http.py`, `FitsHeaderMixin`, `test_basetelescope.py`, `TaskData`, `DummySolarTelescope`, `SolarElevationConstraint`, `Future`, `PolymorphicBaseModel`, `xmppcomm.py`, `acquisition.py`, `test_acquisition.py`, `Proxy`, `robotic/test_scheduler.py`, `SiderealTarget`, `LcoTaskArchive`, `Calibration`, `Portal`, `FilenameFormatter`, `test_yaml_archives.py`, `test_schedulewriter.py`, `test_astroplanscheduler.py`, `TimeDelta`, `Offsets`, `.now`, `test_proxy.py`, `IPointingAltAz`, `test_control.py`, `Weather`, `test_schedulereader.py`, `Application`, `test_pyobs_archive.py`, `FrameInfo`, `InfluxHandler`, `test_lcoscript.py`, `test_coordinates.py`, `test_transit.py`, `LocalArchive`, `CommLoggingHandler`, `FocusModel`, `test_darkbias.py`, `timeout`, `Grid`, `test_reduction.py`, `LcoTask`, `FromList`, `BaseGuiding`, `ExpTimeEval`, `SchedulerItem`, `Script`, `NewImageEvent`, `Scheduler`, `test_autofocus.py`, `ImageType`, `TaskStartedEvent`, `test_transit_mastermind.py`, `GridNode`, `Object`, `GoodWeatherEvent`, `ConfigStatus`, `object.py`, `RunningState`, `Scheduler`, `.__init__`, `._filter_data`, `ObservationList`, `.__get_script`, `.get_sensor_value`, `DummyCamera`, `pyobs/modules/utils/__init__.py`, `_ProxyContext`, `.night_obs`, `.__call__`?**
  _High betweenness centrality (0.226) - this node is a cross-community bridge._
- **Why does `Image` connect `Image` to `utils/exceptions.py`, `.__init__`, `RuntimeError`, `ImageProcessor`, `Interface`, `test_reduction.py`, `GuidingStatistics`, `VirtualFileSystem`, `mixins/test_fitsheader.py`, `Event`, `._filter_data`, `GuidingStatisticsPixelOffset`, `GuidingStatisticsSkyOffset`, `CatalogCircularMask`, `test_flatfielder.py`, `FitsHeaderMixin`, `SoftBin`, `AddMask`, `BaseGuiding`, `_SourceCatalog`, `test_autoguiding.py`, `DummyCamera`, `acquisition.py`, `test_acquisition.py`, `test_aperture_photometry.py`, `_PhotometryCalculator`, `Calibration`, `_ResponseImageWriter`, `_CalibrationCache`, `.get_meta`, `FilenameFormatter`, `test_basevideo.py`, `FlatFielder`, `Offsets`, `AstrometryDotNet`, `.__call__`, `PipelineMixin`, `Ring`, `._get_radec_center_target`, `AperturePhotometry`, `.__call__`, `Smooth`, `ProjectedOffsets`, `ImageType`, `test_pyobs_archive.py`, `FrameInfo`, `FocusSeries`, `_DaoBackgroundRemover`, `LocalArchive`, `_PhotUtilAperturePhotometry`, `_SepAperturePhotometry`, `VFSFile`, `ImageSourceFilter`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `Comm` connect `Comm` to `Module`, `object.py`, `flatfield/test_scheduler.py`, `test_dummymode.py`, `FlatField`, `Interface`, `test_camerasettings.py`, `test_kiosk.py`, `mixins/test_fitsheader.py`, `test_flatfielder.py`, `LocalComm`, `tests/test_events.py`, `FitsHeaderMixin`, `DummySolarTelescope`, `test_autoguiding.py`, `PolymorphicBaseModel`, `xmppcomm.py`, `test_acquisition.py`, `._get_client`, `Proxy`, `XmppComm`, `robotic/test_scheduler.py`, `test_stellarexptime.py`, `test_dummyvideo.py`, `.clients_with_interface`, `test_shellcommand.py`, `ScriptRunner`, `FilenameFormatter`, `test_basevideo.py`, `_ProxyContext`, `ModuleNameFilter`, `test_httpfilecache.py`, `comm/test_events.py`, `IPointingAltAz`, `XmppClient`, `.__init__`, `DummyComm`, `make_proxy_cm`, `get_registered_interface`, `Object`, `CommLoggingHandler`, `test_dummyradectelescope.py`, `test_version_mismatch.py`, `test_dummyaltaztelescope.py`?**
