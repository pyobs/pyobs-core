...
image_relation = Table(
    "pyobs_image_relation", Base.metadata,
    Column("image_id", Integer, ForeignKey("pyobs_image.id"), index=True),
    Column("parent_id", Integer, ForeignKey("pyobs_image.id"), index=True)
)
