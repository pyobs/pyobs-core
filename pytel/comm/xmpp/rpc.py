...
from pytel.modules import PytelModule
from pytel.comm.exceptions import *
from pytel.utils.threads import Future
...
class RPC(object):
    ...
    def __init__(self, client: sleekxmpp.ClientXMPP, handler: PytelModule = None):
        """Create a new RPC wrapper.

        Args:
            client: XMPP client tu use for communication.
            handler: pytel module that handles function calls.
        """
