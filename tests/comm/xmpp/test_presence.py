...
@pytest.mark.asyncio
async def test_get_capabilities_returns_version_and_label() -> None:
    """Default get_capabilities() must return version and label keys."""
    module = Module.__new__(Module)
    module._label = "Test Camera"

    caps = await module.get_capabilities()
...
@pytest.mark.asyncio
async def test_get_capabilities_none_label() -> None:
    """get_capabilities() with no label returns empty string."""
    module = Module.__new__(Module)
    module._label = None
