"""Tests for Application's module_factory path (see specs/plans/gui-interactive-login.md), the
config-file path's DummyComm-naming fallback, and that the existing config-file path keeps working
unchanged."""
